...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-4">
      ...
      <Field.Root class="flex flex-none items-center w-16 px-2 h-8 rounded border border-gray-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-accent">
        <Field.Input
