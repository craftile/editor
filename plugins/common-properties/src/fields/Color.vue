...
<template>
  ...
  >
    ...
    <ColorPicker.Control class="flex gap-2">
      <ColorPicker.Trigger class="appearance-none rounded cursor-pointer inline-flex items-center justify-center outline-none h-10 min-w-10 gap-2 border border-gray-300">
