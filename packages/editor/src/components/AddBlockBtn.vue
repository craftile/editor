...
<template>
  <div ref="el" class="relative flex items-center w-full h-1.5 transition-colors group rounded">
    <div
      class="h-[2px] w-0 bg-accent/70 group-hover:w-full transition-[width] duration-100 absolute left-1/2 transform -translate-x-1/2"
    ></div>
    <button
